...
try:
    import readline
    import rlcompleter  # Import need for completion
    import atexit
except ImportError:
...
WELCOME = """%(Green)s
Found PYTHONSTARTUP env. Using file %(file)s
Features:
  * Colors
  * Tab completion
  * \e Starts a python editor
  * Default pretty print
  * SECRET_KEY function
  * Django addons if DJANGO_SETTINGS_MODULE in env
%(Normal)s
""" % dict(_c.items() + [('file', __file__)])
